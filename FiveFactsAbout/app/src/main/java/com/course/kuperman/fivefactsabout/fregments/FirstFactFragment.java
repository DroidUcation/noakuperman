...
public class FirstFactFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_first_fact,container,false);
        Uri uri = Uri.withAppendedPath(FiveFactsContract.CONTENT_URI,"1");
        Cursor cursor = getActivity().getContentResolver().query(uri, null, null, null, null);
        if(cursor.moveToFirst())
        {
            String fact = cursor.getString(2);
            TextView view = (TextView)rootView.findViewById(R.id.txtView1);
