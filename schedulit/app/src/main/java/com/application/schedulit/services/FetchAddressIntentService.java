...
public class FetchAddressIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (addresses == null || addresses.size()  == 0) {
            ...
            StringBuffer smsBodyMap = new StringBuffer();
            smsBodyMap.append(TextUtils.join(System.getProperty("line.separator"), addressFragments));
           // smsBodyMap.append(" ");
           // smsBodyMap.append(Uri.parse(uri));
            //addressFragments.add(smsBodyMap.toString());
            Log.i(TAG, getString(R.string.address_found));
            deliverResultToReceiver(Constants.SUCCESS_RESULT,TextUtils.join(System.getProperty("line.separator"), addressFragments));
            //deliverResultToReceiver(Constants.SUCCESS_RESULT, smsBodyMap.toString());
        }
    }
